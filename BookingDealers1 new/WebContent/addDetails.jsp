...
<div class="tablink" ><span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>  Add Dealer</div>  
<div id="mySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <a href="login.jsp">Dashboard</a>
  <a href="searchResult2.jsp">Search Dealer</a>
...
<div >
  <input type="text"   placeholder="Enter Name" id="nameID"  required class="inputField">
</div>
...
<div>
  ...
  <input type="text"    placeholder="Enter Country" id="CountryID"  required class="inputField">
...
<button type="submit"  style="width:10%"   onclick="loadMapWITHlOcation();"  >Search Address</button>
 <button type="submit"  style="width:10%"   onclick="sendInfo();"  >Add User</button>
</div>
<div>
