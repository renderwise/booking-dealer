...
<div class="tablink" ><span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>  Orthodontist</div>  
<div id="mySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <a href="login.jsp">Dashboard</a>
  <a href="addClinics.jsp">32watts Provider Clinic</a>
...
<div >
  ...
  <input type="text"   placeholder="Enter EmailID" id="mailID" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required class="inputField">
</div>
...
<button type="submit"  style="width:10%"   onclick="loadMapWITHlOcation();"  >Search Address</button>
 <button type="submit"  style="width:10%"   onclick="sendInfoOrtho();"  >Add User</button>
</div>
<div>
